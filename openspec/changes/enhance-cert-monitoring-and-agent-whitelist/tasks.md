...
- [ ] 3.8 Add integration tests for authenticated and unauthenticated requests
...
- [ ] 4.8 Add API tests for whitelist management endpoints
...
- [ ] 6.5 Add integration tests for certificate collection and storage
...
- [ ] 7.8 Add API tests for certificate endpoints

## 8. Certificate Expiration Alerting

- [ ] 8.1 Create CertificateExpirationRule in oxmon-alert crate
- [ ] 8.2 Implement alert rule that checks certificate expiration thresholds
- [ ] 8.3 Add configurable warning threshold (default: 30 days)
- [ ] 8.4 Add configurable critical threshold (default: 7 days)
- [ ] 8.5 Include certificate details in alert payload (domain, expiration, issuer, IPs)
- [ ] 8.6 Integrate certificate expiration rule with alert engine
- [ ] 8.7 Add tests for certificate expiration alerting
...
- [ ] 9.4 Update agent documentation with authentication setup instructions
...
- [ ] 10.3 Add API documentation for whitelist endpoints to OpenAPI spec
- [ ] 10.4 Add API documentation for certificate endpoints to OpenAPI spec
- [ ] 10.5 Run full integration test suite
- [x] 10.6 Run clippy and fix any warnings
- [ ] 10.7 Update CLAUDE.md if new patterns or commands are introduced
